package dev.imlukas.ultraspawners.utils.command.impl;

import dev.imlukas.ultraspawners.UltraSpawnersPlugin;
import dev.imlukas.ultraspawners.utils.command.BaseCommand;
import dev.imlukas.ultraspawners.utils.command.SimpleCommand;
import dev.imlukas.ultraspawners.utils.command.comparison.ComparisonResult;
...
public class CommandManager {
    ...
    private final UltraSpawnersPlugin main;

    public CommandManager(UltraSpawnersPlugin main) {
        this.main = main;
    }
